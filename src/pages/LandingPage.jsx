...
const InteractiveViewer = () => {
  ...
  return (
    <div className="viewer-container viewer-container-grid">
    ...
    <div className="landing-page-root">
        ...
        <div className="container header-content">
          ...
          <div style={{display: 'flex', gap: '15px', alignItems: 'center'}}>
            ...
            <button 
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-main)', padding: '8px' }}
            >
              <Menu size={24} />
            </button>
          </div>
      ...
      <div className={`mobile-drawer ${isMobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-drawer-content">
          <a href="#about" onClick={() => setIsMobileMenuOpen(false)}>Về chúng tôi</a>
          <a href="#features" onClick={() => setIsMobileMenuOpen(false)}>Ưu điểm</a>
          <a href="#products" onClick={() => setIsMobileMenuOpen(false)}>Sản phẩm</a>
